    ...
    return (
      <Router createReducer={reducerCreate}>
        <Scene key="modal" component={Modal} >
          <Scene key="root">
            <Scene key="main">
              <Scene key="timeline" navigationBarStyle={{backgroundColor: '#FFBF02', borderBottomWidth: 0}} initial={true} component={Timeline} title={<Icon name="md-beer" size={27} color='#fff'/>}/>
            </Scene>
